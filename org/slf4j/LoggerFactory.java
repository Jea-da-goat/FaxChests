...
/*  92 */   static final SubstituteServiceProvider SUBST_PROVIDER = new SubstituteServiceProvider();
...
/* 416 */       synchronized (LoggerFactory.class) {
/* 417 */         if (INITIALIZATION_STATE == 0) {
/* 418 */           INITIALIZATION_STATE = 1;
/* 419 */           performInitialization();
/*     */         } 
/*     */       } 
/*     */     }
/* 423 */     switch (INITIALIZATION_STATE) {
/*     */       case 3:
/* 425 */         return PROVIDER;
/*     */       case 4:
/* 427 */         return (SLF4JServiceProvider)NOP_FALLBACK_FACTORY;
/*     */       case 2:
/* 429 */         throw new IllegalStateException("org.slf4j.LoggerFactory in failed state. Original exception was thrown EARLIER. See also http://www.slf4j.org/codes.html#unsuccessfulInit");
/*     */ 
/*     */       
/*     */       case 1:
/* 433 */         return (SLF4JServiceProvider)SUBST_PROVIDER;
/*     */     } 
/* 435 */     throw new IllegalStateException("Unreachable code");
/*     */   }
/*     */ }


/* Location:              G:\FAXONLINE\bin\plugins\FaxChests-1.0-SNAPSHOT.jar!\org\slf4j\LoggerFactory.class
